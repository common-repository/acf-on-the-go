        ...
        public function acfg_front_scripts() {
           if(is_user_logged_in()){
                ...
                wp_localize_script( 'acfg-front-js', 'js_object', array(
                    ...
                    'success_txt' => __( 'Success', ACFG_TEXTDOMAIN),
                    'nochange_txt' => __( 'No change', ACFG_TEXTDOMAIN),
                    'success_msg' => __( 'Updated Successfully', ACFG_TEXTDOMAIN),
                    'nochange_msg' => __( 'Nothing to change', ACFG_TEXTDOMAIN),
                ));
            }
        }
    }
